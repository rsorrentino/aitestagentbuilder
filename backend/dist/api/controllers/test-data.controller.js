...
export class TestDataController {
    testDataRepo = new TestDataRepository();
    ...
    async listTestData(req, res) {
        try {
            ...
            let testData;
            if (environment) {
                testData = await this.testDataRepo.findByEnvironment(environment);
            }
            else {
