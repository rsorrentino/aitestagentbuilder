...
export class ReportingAgentService {
     ...
     */
    async generateReports(runId, options) {
        ...
        for (const format of options.formats) {
            try {
                ...
                await this.db.query(`INSERT INTO reports (id, run_id, format, file_path, content, generated_at)
           VALUES ($1, $2, $3, $4, $5, $6)`, [
    ...
    generateJSONReport(run, options) {
        const report = {
            runId: run.id,
            agentId: run.agentId,
            status: run.status,
    ...
    generateHTMLReport(run, options) {
...
//# sourceMappingURL=reporting-agent.service.js.map